...
import { deepEqual as areEqual } from "../deepEqual";
...
describe("areEqual", function () {
	...
	it("works with multidimensional arrays", () => {
		const a = [
			Number(47),
			false,
			"Larry",
	...
	it("works with simple objects", function () {
		...
		const a = {
			...
			film: {
				...
				stars: [String("Larry Fine"), "Hemp Howard"],
				minutes: Number(16),
				seconds: 54,
			},
		};
	...
	it("works with circular arrays", () => {
		...
		b.push("Curly");
		/*
		 * Arrays containing circular references and different properties
		 * are not equal
		 */
		expect(areEqual(a, b)).toBe(false);
	...
	it("should compare two equal objects and return true", () => {
		let a: { a?: any; b?: any; c?: any; 1?: any; 2?: any; 3?: any } = {
				a: 1,
				b: 2,
				c: 3,
			},
			b: { a?: any; b?: any; c?: any; 1?: any; 2?: any; 3?: any } = {
				a: 1,
				b: 2,
				c: 3,
			};
